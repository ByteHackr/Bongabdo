...
// Year-month specific overrides based on bengalicalendar.com verification
// Format: year -> monthIndex -> {firstDay: 'YYYY-MM-DD' (optional), lastDay: 'YYYY-MM-DD', length: number}
// If firstDay is not specified, it defaults to Sankranti date + 1
export const YEAR_MONTH_OVERRIDES = {
    1432: {
        0: { firstDay: '2025-04-15', lastDay: '2025-05-15', length: 31 },  // Boishakh 1432 (Sankranti early, so Sankranti date is Day 1)
        9: { firstDay: '2026-01-15', lastDay: '2026-02-13', length: 30 },  // Magh 1432 (Sankranti early, so Sankranti date is Day 1)
        10: { firstDay: '2026-02-14', lastDay: '2026-03-14', length: 29 }, // Falgun 1432 (Sankranti early, so Sankranti date is Day 1)
        11: { lastDay: '2026-04-13', length: 29 }, // Choitro 1432
    },
    1433: {
...
export function calculateMonthLengthBisuddhaSiddhanta(monthStart, nextMonthStart, monthIndex, bengaliYear = null) {
    ...
    // First day is always the day after Sankranti
    ...
    if (bengaliYear && YEAR_MONTH_OVERRIDES[bengaliYear]?.[monthIndex]) {
        ...
        // If firstDay is specified in override, use it; otherwise use default (Sankranti + 1)
